...
public abstract class EducationConverter {
     ...
     * al atributo org.eclipse.uml2.uml.internal.impl.PropertyImpl@94cdd4f (name: translator, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false) de EducationEntity. Se usa cuando se necesita convertir
     ...
     * actualizar varios EducationEntity con el mismo org.eclipse.uml2.uml.internal.impl.PropertyImpl@94cdd4f (name: translator, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false)
     * @param dtos Colección de instancias de EducationDTO
     * @param parent Instancia de TranslatorEntity
     * @return Colección de EducationEntity con el atributo org.eclipse.uml2.uml.internal.impl.PropertyImpl@94cdd4f (name: translator, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false) asignado
     * @generated
     */
