...
public class TranslationRequestTest {
    ...
    public void createTranslationRequestTest() throws IOException {
        ...
        Assert.assertEquals(translationRequest.getStatus(), translationrequestTest.getStatus());
    ...
    public void getTranslationRequestById() {
        ...
        Assert.assertEquals(translationrequestTest.getStatus(), oraculo.get(0).getStatus());
    }
    ...
    public void updateTranslationRequestTest() throws IOException {
        ...
        translationRequest.setStatus(translationRequestChanged.getStatus());
