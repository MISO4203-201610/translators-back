...
public interface ITranslatorLogic {
    ...
    public KnowledgeAreaEntity getKnowledgeAreas(Long translatorId, Long knowledgeAreaId);
    public KnowledgeAreaEntity addKnowledgeAreas(Long translatorId, Long knowledgeAreaId);
